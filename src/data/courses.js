...
export const courses = [
  ...
  },
  {
    ...
    chapters: [
      {
        chapterId: 1,
        title: "chapter one algebre",
        chapterDescription: (
          <p>
            If we create an index table on the student ID column, it would be
            considered dense because the file is Ordered on Id.
            <br></br>
            In this example, a dense index on the student ID does not conatain
            all the students Id,(for example it could contain the last/first
            student ID of each Block)
            <br></br>
            But if we create an index table on the department ID column, it
            would be considered non-dense, the file is not Ordered on department
            Id
            <br></br>
            In this example, a non-dense index on the department ID conatains
            all the Departements Id
          </p>
        ),
        subChapter: [
          {
